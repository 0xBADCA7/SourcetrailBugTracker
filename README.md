...
* Linux: Fixed issue in sourcetrail.sh script (issue [#638](https://github.com/CoatiSoftware/CoatiBugTracker/issues/638))
* Inspect errors during indexing (issue [#235](https://github.com/CoatiSoftware/CoatiBugTracker/issues/235))
* C/C++: Fixed header path selection in Source Group setup also preselects non exsiting paths (issue [#640](https://github.com/CoatiSoftware/CoatiBugTracker/issues/640))
...
* C/C++: Fixed shrinking shared memory below initial size (issue [#636](https://github.com/CoatiSoftware/CoatiBugTracker/issues/636))
* Fixed indexers still waiting until less storages are queued, although indexing was already interrupted (issue [#634](https://github.com/CoatiSoftware/CoatiBugTracker/issues/634))
...
* Added tabs UI to top of main window (issue [#215](https://github.com/CoatiSoftware/CoatiBugTracker/issues/215))
* Linux: Fixed no write permission to ~/.config/sourcetrail after installation (issue [#625](https://github.com/CoatiSoftware/CoatiBugTracker/issues/625), [#626](https://github.com/CoatiSoftware/CoatiBugTracker/issues/626))
...
* JAVA: display multi-line maven error messages (issue [#622](https://github.com/CoatiSoftware/CoatiBugTracker/issues/622))
...
* C/C++: record and display indexer configuration issues (issue [#618](https://github.com/CoatiSoftware/CoatiBugTracker/issues/618))
...
* Fixed source extensions not converted to lowercase (issue [#614](https://github.com/CoatiSoftware/CoatiBugTracker/issues/614))
* C/C++: fixed line of errors wrong when appearing after #line directives (issue [#610](https://github.com/CoatiSoftware/CoatiBugTracker/issues/610))
* Graph: Clear graph contents on overview (issue [#609](https://github.com/CoatiSoftware/CoatiBugTracker/issues/609))
* Windows: Fixed policy for finding Windows user data folder (issue [#612](https://github.com/CoatiSoftware/CoatiBugTracker/issues/612))
...
* C/C++: fixed endless loop in include path auto detection (issue [#585](https://github.com/CoatiSoftware/CoatiBugTracker/issues/585), [#470](https://github.com/CoatiSoftware/CoatiBugTracker/issues/470))
...
* Fixed macOS gatekeeper refusing to open app bundle (issue [#568](https://github.com/CoatiSoftware/CoatiBugTracker/issues/568))
* Use custom radio button style on start indexing dialog to fix radio indicator not visible on old Windows systems
* Fixed indexed header paths in compilation database project change the processing order of includes (issue [#571](https://github.com/CoatiSoftware/CoatiBugTracker/issues/571))
* Allow tooltips to be as wide as the window (issue [#570](https://github.com/CoatiSoftware/CoatiBugTracker/issues/570))
...
* Fixed file picker didn't start in recent directory when exporting graph as image (issue [#541](https://github.com/CoatiSoftware/CoatiBugTracker/issues/541))
...
* Linux: Added settings to change screen scaling to preferences (issue [#518](https://github.com/CoatiSoftware/CoatiBugTracker/issues/518), [#523](https://github.com/CoatiSoftware/CoatiBugTracker/issues/523))
* Allow for disabling certain Source Groups via Status checkbox in the "Edit Project" dialog
* C/C++: Fixed no indexed information saved for compilation database referencing certain compiler (issue [#531](https://github.com/CoatiSoftware/CoatiBugTracker/issues/531))
...
* Code: Show scrollbar at bottom of snippet list if bottom snippet is horizontally scrollable (issue [#432](https://github.com/CoatiSoftware/CoatiBugTracker/issues/432))
* Code: Keep snippet title bar at top when scrolling down (issue [#479](https://github.com/CoatiSoftware/CoatiBugTracker/issues/479))
...
* Linux: Don't explicitely open terminal when running on Linux (issue [#525](https://github.com/CoatiSoftware/CoatiBugTracker/issues/525))
* Fixed files and directories dialog to offer selection of files (issue [#521](https://github.com/CoatiSoftware/CoatiBugTracker/issues/521))
...
* Search: Fixed selected text not deleted when pasting into search field (issue [#527](https://github.com/CoatiSoftware/CoatiBugTracker/issues/527))
...
* Don't force full project refresh when project settings changed (issue [#493](https://github.com/CoatiSoftware/CoatiBugTracker/issues/493))
* Added indexing mode to reindex incomplete files (issue [#496](https://github.com/CoatiSoftware/CoatiBugTracker/issues/496))
...
* Graph: Update visible depth graph when changing depth level slider (issue [#484](https://github.com/CoatiSoftware/CoatiBugTracker/issues/484))
* Always show all context menu actions, but disable unavailable ones
* Graph: Hide nodes and edges via context menu action or Alt + Click (issue [#472](https://github.com/CoatiSoftware/CoatiBugTracker/issues/472))
* Graph: Added option to preferences to show/hide builtin types, default is hidden (issue [#409](https://github.com/CoatiSoftware/CoatiBugTracker/issues/409))
...
* Linux: Fixed syntax error in Sourcetrail.sh (issue [#519](https://github.com/CoatiSoftware/CoatiBugTracker/issues/519))
* Graph: Improved exported image quality
* Graph: Fixed exported graph image were too large (issue [#511](https://github.com/CoatiSoftware/CoatiBugTracker/issues/511))
...
* C/C++: Fixed filepaths to always be canonical (issue [#516](https://github.com/CoatiSoftware/CoatiBugTracker/issues/516))
* Graph: Fixed implicit nodes not auto-expanded when activated
* C/C++: Add filename info to static functions (issue [#515](https://github.com/CoatiSoftware/CoatiBugTracker/issues/515))

#### 2017.4.46
released 2017-11-09

* C/C++: Add filename info to static global variables to avoid collision (issue [#514](https://github.com/CoatiSoftware/CoatiBugTracker/issues/514))
* Allow duplicate indexing of source files if the indexer command differs
* Fixed single header files within indexed paths were not indexed (issue [#513](https://github.com/CoatiSoftware/CoatiBugTracker/issues/513))
* Status: Explain differences of errors and how to fix them in help message dialog (issue [#501](https://github.com/CoatiSoftware/CoatiBugTracker/issues/501))
...
* Graph: Show nodes with more than 20 children initially collapsed (issue [#509](https://github.com/CoatiSoftware/CoatiBugTracker/issues/509))
* Show message box informing about shared memory problems before indexing (issue [#508](https://github.com/CoatiSoftware/CoatiBugTracker/issues/508))
...
* Status: Fixed resize status view table columns were only resizeable in the title bar (issue [#506](https://github.com/CoatiSoftware/CoatiBugTracker/issues/506))
* Added setting for text encoding to preferences (issue [#500](https://github.com/CoatiSoftware/CoatiBugTracker/issues/500))
* Search: Fixed low contrast of search field cursor in dark schemes (issue [#487](https://github.com/CoatiSoftware/CoatiBugTracker/issues/487))

#### 2017.4.20
released 2017-10-25

* Code: Fixed file state of snippets wrong after iterating references in single file view
* Search: Improved selection on focus to allow editing of search query (issue [#483](https://github.com/CoatiSoftware/CoatiBugTracker/issues/483))
* Code: Fixed last line removed in full file view
* Fixed local symbol activation via plugin shows empty view
* Fixed handling of symbolic links when activated via plugin (issue [#489](https://github.com/CoatiSoftware/CoatiBugTracker/issues/489))
* Code: Fixed crash due to double deletion of elements (issue [#488](https://github.com/CoatiSoftware/CoatiBugTracker/issues/488))
...
* Graph: Bundle nested anonymous namespaces into anonymous namespace bundle in namespace overview (issue [#465](https://github.com/CoatiSoftware/CoatiBugTracker/issues/465))
...
* Windows: Added missing Qt dlls to save graph images as .jpg (issue [#474](https://github.com/CoatiSoftware/CoatiBugTracker/issues/474))
* C/C++: Updated to Clang 5.0.0
* Code: Fixed annotations missing for full file snippets
* Java: Added project setup from Gradle (issue [#379](https://github.com/CoatiSoftware/CoatiBugTracker/issues/379))
* Added "Find On-Screen" option with search bar at bottom of window for searching Graph and Code on-screen (issue [#79](https://github.com/CoatiSoftware/CoatiBugTracker/issues/79))
...
* Added node type keywords to filter autocompletions or activate all nodes (issue [#78](https://github.com/CoatiSoftware/CoatiBugTracker/issues/78))
* File dialog shows home directory instead of working directory for first file dialog (issue [#448](https://github.com/CoatiSoftware/CoatiBugTracker/issues/448))
* Java: improved Maven timeout policy (issue [#449](https://github.com/CoatiSoftware/CoatiBugTracker/issues/449))
